...
Route::prefix('admin')->middleware([JwtAuth::class, AdminOnly::class])->group(function () {
    ...
    Route::put('/routes/{id}', [CourierApiController::class, 'adminUpdateRoute']);
    Route::delete('/routes/{id}', [CourierApiController::class, 'adminDeleteRoute']);
...
Route::middleware(JwtAuth::class)->group(function () {
    ...
    Route::post('/products/reorder', [ProductApiController::class, 'reorder'])->name('api.products.reorder');
    ...
    Route::post('/customers/{customerNo}/update', [CustomerApiController::class, 'update'])->name('api.customers.update');
    Route::put('/customers/{customerNo}', [CustomerApiController::class, 'update'])->name('api.customers.put');
    Route::delete('/customers/{customerNo}', [CustomerApiController::class, 'destroy'])->name('api.customers.destroy');
