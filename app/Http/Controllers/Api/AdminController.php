...
class AdminController extends Controller
{
    ...
    private function formatEmployee(User $emp): array
    {
        return [
            ...
            'gajiPerhari' => (int) $emp->gaji_perhari,
            'gaji_perhari' => (int) $emp->gaji_perhari,
            'hariKerja' => $emp->hari_kerja,
            'hari_kerja' => $emp->hari_kerja,
            'jamMasukKerja' => $emp->jam_masuk_kerja,
            'jam_masuk_kerja' => $emp->jam_masuk_kerja,
            'jamKeluarKerja' => $emp->jam_keluar_kerja,
            'jam_keluar_kerja' => $emp->jam_keluar_kerja,
            'fotoProfil' => $emp->foto_profil,
            'masterLokasiId' => $emp->master_lokasi_id,
            'master_lokasi_id' => $emp->master_lokasi_id,
